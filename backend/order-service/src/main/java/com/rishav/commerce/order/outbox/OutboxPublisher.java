...
class OutboxPublisher {
    ...
    OutboxPublisher(OutboxEventRepository outboxEvents, ObjectMapper objectMapper,
                    KafkaTemplate<String, OrderCreatedEvent> kafkaTemplate) {
        this.outboxEvents = outboxEvents; this.objectMapper = objectMapper; this.kafkaTemplate = kafkaTemplate;
    }
